...
.DESCRIPTION
    ...
    Azure AI Foundry account, retrieves the endpoint and API key, and writes
...
# 2. Verify AI Foundry account exists
Write-Host "`n[2/4] Checking AI Foundry account '$AccountName'..."
